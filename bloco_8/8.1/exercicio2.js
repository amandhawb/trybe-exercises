...
const confereJogo = (numeroApostado, numeroSorteado) => {
  console.log(numeroApostado === numeroSorteado ? ("Parabéns você ganhou!") : "Tente novamente");
}
const geraNumeroSorteado = (numeroApostado, callback) => {
  let numeroSorteado = Math.floor(Math.random() * 6);
  return callback(numeroApostado, numeroSorteado);
}
geraNumeroSorteado(3, confereJogo);
